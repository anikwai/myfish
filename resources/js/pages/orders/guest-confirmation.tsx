          ...
          <div className="space-y-4">
                  ...
                  {order.items.map((item) => (
                    <div key={item.id} className="flex justify-between text-sm">
                      ...
                      <span className="font-mono text-muted-foreground">
                        {Number(item.quantity_kg).toFixed(3)} kg /{" "}
                        {Number(item.quantity_pounds).toFixed(3)} lbs
                      </span>
                    </div>
                  ))}
                </div>
                  ...
                  {order.filleting && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono">
                        +$
                        {Number(order.filleting_fee_snapshot).toFixed(2)} SBD
                      </span>
                    </div>
                  )}
                  {order.delivery && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono">
                        +$
                        {Number(order.delivery_fee_snapshot).toFixed(2)} SBD
                      </span>
                    </div>
                  )}
            ...
            {canRegister && (
              <Card className="border-primary/20 bg-primary/5">
                <CardContent className="pt-6">
                  <h2 className="font-semibold">Track all your orders</h2>
                  <p className="mt-1 text-sm text-muted-foreground">
                    Create a free account to see your order history, get status
                    updates, and order faster next time.
                  </p>
                  ...
                  <p className="mt-2 text-center text-xs text-muted-foreground">
                    Your guest order will be linked automatically.
                  </p>
                </CardContent>
              </Card>
            )}
